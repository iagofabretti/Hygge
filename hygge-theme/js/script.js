...
const GalleryGrid = {
    ...
    loadImages: function() {
        ...
        // Use themeUrl from wp_localize_script
        const themeUrl = (typeof hyggeTheme !== 'undefined' && hyggeTheme.themeUrl) ? hyggeTheme.themeUrl : '';
        
        fetch(themeUrl + '/fotos.json')
    ...
    createGalleryItem: function(img, index) {
        ...
        item.innerHTML = `
            <img class="gallery-img current" src="${themeUrl}/Fotos/${img}" alt="Hy.gge Salon" loading="lazy">
    ...
    transitionRandomImage: function() {
        ...
        // Set the new image
        nextImg.src = `${themeUrl}/Fotos/${this.images[newImageIndex]}`;
    ...
    prevImage: function() {
        ...
        this.lightboxImg.src = `${themeUrl}/Fotos/${this.images[this.currentIndex]}`;
    },
